...
all : imgs/breast_cancer_malignancy_tree.pdf imgs/max_depth_graph.png imgs/min_sample_split_graph.png
...
imgs/breast_cancer_malignancy_tree.pdf : data/clean_breast_cancer_data_after_dropped_features.csv src/04_final_breast_cancer_malignancy_decision_tree_classifier.py
	python src/04_final_breast_cancer_malignancy_decision_tree_classifier.py data/clean_breast_cancer_data_after_dropped_features.csv imgs/breast_cancer_malignancy_tree.pdf
